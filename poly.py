...
class Poly:
    ...
    def toPOL(self):
        ...
        return b
    #
    def print_full_polynomial(self):
        """
        Prints the full polynomial with all coefficients.
        """
        polynomial_str = ""
        for degree, coeff in enumerate(self.F):
            if degree == 0:
                polynomial_str += str(coeff)
            elif coeff != 0:
                polynomial_str += " + " + str(coeff) + "*x^" + str(degree)
